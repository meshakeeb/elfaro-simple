...
@endif
  <x-icon.svg viewBox="0 0 17.088 13.996" class="{{ $attributes->get('class') }}" stroke="{{ $attributes->get('stroke') }}" focusable="false" preserveAspectRatio="xMidYMid meet" width="32" height="32" viewBox="0 0 32 32" aria-hidden="true">
...
<a href="https://twitter.com/{{ str_replace('@','',$attributes->get('account')) }}" target="_blank"><span class="hidden md:block">{{ $attributes->get('account') }}</span></a>
@endif
